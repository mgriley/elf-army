/**
 * The peer abstraction — one edge in/out of this goblin.
 *
 * A "peer" is whatever this goblin can talk to: its parent, a child it spawned,
 ...
 *
 * Each Goblin communicates with its peers through rpc interfaces. A peer can only
...
/**
 * One edge out of this goblin. A subclass knows how to ship a call to the other
